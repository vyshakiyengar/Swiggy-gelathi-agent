...
export const ZEPTO_PRODUCT_CATALOG: Product[] = [
  ...
  {
    id: 'prod-bev-diet-coke-300ml',
    name: 'Diet Coke Sugar Free Carbonated Soft Drink Can',
    kannadaName: 'ಡಯಟ್ ಕೋಕ್ (Diet Coke Can - 300ml)',
    ...
    stockCount: 50,
    brand: 'Coca-Cola',
    kannadaAliases: ['diet coke', 'dietcoke', 'coke zero', 'coca cola diet', 'sugar free coke', 'coke'],
    imageUrl: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=200&auto=format&fit=crop&q=60'
  },
  {
    id: 'prod-bev-coca-cola-750ml',
    name: 'Coca-Cola Original Taste Soft Drink Bottle',
    kannadaName: 'ಕೋಕಾ-ಕೋಲಾ (Coca-Cola - 750ml)',
    category: 'Cold Drinks & Juices',
    unit: '750 ml Bottle',
    price: 45,
    mrp: 45,
    ...
    stockCount: 40,
    brand: 'Coca-Cola',
    kannadaAliases: ['coke', 'coca cola', 'cool drink', 'cold drink'],
    imageUrl: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=200&auto=format&fit=crop&q=60'
  },
  {
    id: 'prod-bev-thums-up-750ml',
    name: 'Thums Up Charged Soft Drink',
    kannadaName: 'ಥಮ್ಸ್ ಅಪ್ (Thums Up - 750ml)',
    category: 'Cold Drinks & Juices',
    unit: '750 ml Bottle',
    price: 45,
    mrp: 45,
    ...
    stockCount: 45,
    brand: 'Thums Up',
    kannadaAliases: ['thums up', 'thumbs up', 'thumps up', 'cold drink'],
    imageUrl: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=200&auto=format&fit=crop&q=60'
  },
  {
    id: 'prod-bev-sprite-750ml',
    name: 'Sprite Lemon-Lime Flavoured Soft Drink',
    kannadaName: 'ಸ್ಪ್ರೈಟ್ (Sprite - 750ml)',
    category: 'Cold Drinks & Juices',
    unit: '750 ml Bottle',
    price: 45,
    mrp: 45,
    ...
    stockCount: 35,
    brand: 'Sprite',
    kannadaAliases: ['sprite', 'lemon drink', 'cold drink'],
    imageUrl: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=200&auto=format&fit=crop&q=60'
  },
  {
    id: 'prod-bev-bisleri-water-1l',
    name: 'Bisleri Packaged Drinking Mineral Water with Minerals',
    kannadaName: 'ಬಿಸ್ಲೆರಿ ನೀರು (Bisleri Water - 1L)',
    category: 'Cold Drinks & Juices',
    unit: '1 Litre Bottle',
    price: 20,
    mrp: 20,
    ...
    stockCount: 100,
    brand: 'Bisleri',
    kannadaAliases: ['water', 'neeru', 'bisleri', 'mineral water', 'water bottle'],
    imageUrl: 'https://images.unsplash.com/photo-1548839140-29a749e1bc4e?w=200&auto=format&fit=crop&q=60'
  },
  {
    id: 'prod-snack-lays-salted-50g',
    name: 'Lay\'s Classic Salted Potato Chips',
    kannadaName: 'ಲೇಸ್ ಚಿಪ್ಸ್ (Lay\'s Salted Chips - 50g)',
  ...
  },
  {
    ...
    stockCount: 40,
    brand: 'Maggi',
    kannadaAliases: ['maggi', 'maggie', 'noodles', 'instant noodles'],
    imageUrl: 'https://images.unsplash.com/photo-1612927601601-6638404737ce?w=200&auto=format&fit=crop&q=60'
  },
  {
    id: 'prod-snack-good-day-cashew-200g',
    name: 'Britannia Good Day Cashew Cookies',
    kannadaName: 'ಗುಡ್ ಡೇ ಬಿಸ್ಕತ್ತು (Good Day Biscuits - 200g)',
    category: 'Munchies & Chips',
    unit: '200 g',
    price: 38,
    mrp: 45,
    ...
    stockCount: 35,
    brand: 'Britannia',
    kannadaAliases: ['biscuit', 'biscuits', 'good day', 'biskattu'],
